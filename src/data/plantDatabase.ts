...
export const PLANT_DATABASE: PlantSpecies[] = [
	// === BEGINNER PLANTS ===
	{
		...
		characteristics: {
			leafShape: 'long-narrow',
			leafSize: 'large',
			growthPattern: 'upright',
			specialFeatures: ['succulent'],
		},
		careLevel: 'beginner',
		petSafe: false,
		commonIssues: [
	...
	},
	{
		...
		characteristics: {
			leafShape: 'heart',
			leafSize: 'medium',
			growthPattern: 'trailing',
			specialFeatures: ['waxy', 'variegated'],
		},
		careLevel: 'beginner',
		petSafe: false,
		commonIssues: [
	...
	},
	{
		...
		characteristics: {
			...
			leafSize: 'medium',
			growthPattern: 'upright',
			specialFeatures: ['waxy', 'succulent'],
		},
		careLevel: 'beginner',
		petSafe: false,
		commonIssues: [
	...
	},
	{
		...
		characteristics: {
			...
			leafSize: 'small',
			growthPattern: 'bushy',
			specialFeatures: ['succulent', 'colored'],
		},
		careLevel: 'intermediate',
		petSafe: true,
		commonIssues: [
